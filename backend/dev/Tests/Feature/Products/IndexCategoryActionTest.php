...
final class IndexCategoryActionTest extends TestCase
{
    ...
    public function testSucceedRequest(): void
    {
        ...
        self::assertInstanceOf(DateTimeImmutable::class, DateTimeImmutable::createFromFormat(DateTimeInterface::ATOM, $data[0]['children'][0]['createdAt']));
        ...
        self::assertInstanceOf(DateTimeImmutable::class, DateTimeImmutable::createFromFormat(DateTimeInterface::ATOM, $data[1]['children'][0]['createdAt']));
        ...
        self::assertInstanceOf(DateTimeImmutable::class, DateTimeImmutable::createFromFormat(DateTimeInterface::ATOM, $data[1]['children'][1]['createdAt']));
