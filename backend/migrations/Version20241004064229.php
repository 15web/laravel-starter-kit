...
final class Version20241004064229 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE users (id INT AUTO_INCREMENT NOT NULL, password VARCHAR(255) DEFAULT NULL, roles JSON NOT NULL, createdAt DATETIME NOT NULL, email VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci');
